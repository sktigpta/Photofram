...
function Hero() {
    ...
    return (
        <section className="hero-section flex flex-col md:flex-row items-center justify-center text-center">
            ...
            <div className="hero-content">
                ...
                <p className="hero-subtitle">
                    Upload your favorite image and see how it transforms <br />
